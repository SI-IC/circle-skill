...
1. Открой план `@@PLAN@@`. Прочитай раздел «## Фаза @@PHASE_ID@@», а также секции контекста,
   ...
   **Сначала прочитай журнал предыдущих фаз:** `python3 @@PLAN_CLI@@ journal @@PLAN@@`. Там уже-сделанные
   фазы оставили заметки — что построено (инфра, макросы, конфиги, фикстуры, миграции), какие verify-гейты
   оказались слабыми, и явные предупреждения в строках «следующий шаг». Это экономит часы: не переоткрывай
   вслепую то, что предыдущая фаза уже выяснила или подготовила для тебя.
